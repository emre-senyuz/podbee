$(document).ready(function () {
    ...
    _hero.on('initialize.owl.carousel', function (event) {
        _hero.removeClass('d-none');
    });
    ...
    $('.main__carousel--episodes').owlCarousel({
        mouseDrag: true,
        touchDrag: true,
        dots: true,
        loop: true,
    ...
    $('.sidebar__nav-link[data-bs-toggle="collapse"]').on('click', function () {
	...
	<div class="plyr__controls">
		...
		<div class="plyr__wrap">
			...
			<button type="button" class="plyr__control" id="recent-button">
...
$('body').on('click', '#recent-button', function (e) {
    e.preventDefault();
    location.href = $('#recent-podcast').attr('href');
});
$('body').on('click', '[data-js=latest-episode]', function (e) {
    e.preventDefault();
    var _this = $(this);
    $('[data-js=latest-episode-player]').attr('src', _this.data('iframe')).on('load', function () {
        $('#latest-episode-player').addClass('active');
    });
});
$('body').on('click', '[data-js=latest-episode-close]', function (e) {
    e.preventDefault();
    $('#latest-episode-player').removeClass('active');
    setTimeout(function () {
        $('[data-js=latest-episode-player]').unbind('load').removeAttr('src');
    }, 400);
});